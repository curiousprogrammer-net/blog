...
I haven't worked on this release - I'm mostly focusing on [the cloud version](https://codescene.io) -
but my colleagues did a great work in this area.
The new version comes with a completely new UI: more intuitive and and focusing on features auto-discovery.
We're looking forward to hearing customers' feedback.

For codescene.io, we're now adding Bitbucket support (today you can only analyze GitHub repositories).
...
Networking for System Administrators - coming to Book summaries
